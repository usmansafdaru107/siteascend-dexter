...
@section('title', 'Create Campaign Tag')
			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4 class="mb-sm-0">Create Campaign Tag</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <h4 class="card-title mb-4 text-center">Create Campaign Tag</h4>
                            <form action="{{ route('admin.campaign.tag.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
