...
@section('title', 'Contact Tags List')
			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4 class="mb-sm-0">Contact Tags List</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3" style="float: right">
                                <a class="btn btn-outline-dark btn-sm page-title-right" href="{{ route('admin.contact.tag.create') }}">Add New Contact Tag</a>
                            </div>
