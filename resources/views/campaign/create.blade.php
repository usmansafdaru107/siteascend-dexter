                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <h4 class="card-title mb-4 text-center">Create Campaign</h4>
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="clientName" id="clientName" class="form-control @error('clientName') is-invalid @enderror" value="{{ old('clientName') }}" required maxlength="255">
                                            @error('clientName')
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="solution" id="solution" class="form-control @error('solution') is-invalid @enderror" value="{{ old('solution') }}" required maxlength="255">
                                            @error('solution')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="solutionURL" id="solutionURL" class="form-control @error('solutionURL') is-invalid @enderror" value="{{ old('solutionURL') }}" required maxlength="255">
                                            @error('solutionURL')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="salesRep" id="salesRep" class="form-control @error('salesRep') is-invalid @enderror" value="{{ old('salesRep') }}" required maxlength="255">
                                            @error('salesRep')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-4">
                                            ...
                                            <input type="email" name="salesRepEmail" id="salesRepEmail" class="form-control @error('salesRepEmail') is-invalid @enderror" value="{{ old('salesRepEmail') }}" required maxlength="255">
                                            @error('salesRepEmail')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="salesRepNumber" id="salesRepNumber" class="form-control @error('salesRepNumber') is-invalid @enderror" value="{{ old('salesRepNumber') }}" required maxlength="255">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="salesRepBridge" id="salesRepBridge" class="form-control @error('salesRepBridge') is-invalid @enderror" value="{{ old('salesRepBridge') }}" required maxlength="255">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="calendarAccess" id="calendarAccess" class="form-control @error('calendarAccess') is-invalid @enderror" value="{{ old('calendarAccess') }}" required maxlength="255">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="calendarUsername" id="calendarUsername" class="form-control @error('calendarUsername') is-invalid @enderror" value="{{ old('calendarUsername') }}" required maxlength="255">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="calendarPassword" id="calendarPassword" class="form-control @error('calendarPassword') is-invalid @enderror" value="{{ old('calendarPassword') }}" required maxlength="255">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="calendarInviteAdmin" id="calendarInviteAdmin" class="form-control @error('calendarInviteAdmin') is-invalid @enderror" value="{{ old('calendarInviteAdmin') }}" required maxlength="255">
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="mb-4">
                                            ...
                                            <select class="select2 form-control select2-multiple" name="dgr[]" multiple="multiple" required data-placeholder="Choose DGRs for campaign">
                                                @foreach ($dgrs as $dgr)
                                                    <option value="{{ $dgr->id }}">{{ $dgr->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('dgr')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="DGRAlias" id="DGRAlias" class="form-control @error('DGRAlias') is-invalid @enderror" value="{{ old('DGRAlias') }}" required maxlength="255">
                                            @error('DGRAlias')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="CSRAlias" id="CSRAlias" class="form-control @error('CSRAlias') is-invalid @enderror" value="{{ old('CSRAlias') }}" required maxlength="255">
                                            @error('CSRAlias')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="date" name="campaignStartDate" id="campaignStartDate" class="form-control @error('campaignStartDate') is-invalid @enderror" value="{{ old('campaignStartDate', 'mm-dd-yyyy') }}" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="date" name="expectedEndDate" id="expectedEndDate" class="form-control @error('expectedEndDate') is-invalid @enderror" value="{{ old('expectedEndDate', 'mm-dd-yyyy') }}" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="date" name="actualFinishedDate" id="actualFinishedDate" class="form-control @error('actualFinishedDate') is-invalid @enderror" value="{{ old('actualFinishedDate', 'mm-dd-yyyy') }}">
